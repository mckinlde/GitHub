...
def retrieve(url: str):
    ...
    sleep(320) #github ratelimits me at 60 requests/hour
...
with open('/Users/studentuser/PycharmProjects/GitHub/data/repo ages - ages.csv','r') as userFile:
     with open('/Users/studentuser/PycharmProjects/GitHub/data/repo ages - ages1.csv', 'w') as writeFile:
