...
#Let's get a list of all the users a user follows

#URL will be of format: https://github.com/ USERNAME ?tab=following
BASE_URL = "https://github.com/"
URL_END = "?tab=following"
...
print(get_followed_usernames('mckinlde'))
